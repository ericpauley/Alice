...
public class FallDownAnimation extends AbstractBodyPositionAnimation {
	...
	public class RuntimeFallDownAnimation extends RuntimeAbstractBodyPositionAnimation {
		...
		/*
		 * public void setInitialOrientations() { rightUpperArmInitialOrient =
		 * rightUpperArm.getOrientationAsAxes(rightUpperArm);
		 * leftUpperArmInitialOrient =
		 * leftUpperArm.getOrientationAsAxes(leftUpperArm); if (rightLowerArm !=
		 * null) rightLowerArmInitialOrient =
		 * rightLowerArm.getOrientationAsAxes(rightLowerArm); if (leftLowerArm
		 * != null) leftLowerArmInitialOrient =
		 * leftLowerArm.getOrientationAsAxes(leftLowerArm); }
		 */
