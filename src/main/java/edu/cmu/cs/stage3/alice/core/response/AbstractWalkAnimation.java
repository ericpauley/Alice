...
public class AbstractWalkAnimation extends Animation implements PropertyListener {
	...
	public class RuntimeAbstractWalkAnimation extends RuntimeAnimation {
		...
		public void prologue(double t) {
			...
			if (armAmount.getValue().equals(edu.cmu.cs.stage3.alice.core.Amount.HUGE)) {
				upperArmAngle = 0.8;
				lowerArmAngle = 1.2;
			} else if (armAmount.getValue().equals(edu.cmu.cs.stage3.alice.core.Amount.BIG)) {
				upperArmAngle = 0.675;
				lowerArmAngle = 0.925;
			} else if (armAmount.getValue().equals(edu.cmu.cs.stage3.alice.core.Amount.NORMAL)) {
				upperArmAngle = 0.55;
				lowerArmAngle = 0.65;
			} else if (armAmount.getValue().equals(edu.cmu.cs.stage3.alice.core.Amount.LITTLE)) {
				upperArmAngle = 0.425;
				lowerArmAngle = 0.375;
			} else if (armAmount.getValue().equals(edu.cmu.cs.stage3.alice.core.Amount.TINY)) {
				upperArmAngle = 0.3;
				lowerArmAngle = 0.1;
			}

			if (bounceAmount.getValue().equals(edu.cmu.cs.stage3.alice.core.Amount.HUGE)) {
				recoilFrontUpperAngle = 0.5;
				recoilBackLowerAngle = 2.0;
			} else if (bounceAmount.getValue().equals(edu.cmu.cs.stage3.alice.core.Amount.BIG)) {
				recoilFrontUpperAngle = 0.37;
				recoilBackLowerAngle = 1.625;
			} else if (bounceAmount.getValue().equals(edu.cmu.cs.stage3.alice.core.Amount.NORMAL)) {
				recoilFrontUpperAngle = 0.25;
				recoilBackLowerAngle = 1.25;
			} else if (bounceAmount.getValue().equals(edu.cmu.cs.stage3.alice.core.Amount.LITTLE)) {
				recoilFrontUpperAngle = 0.12;
				recoilBackLowerAngle = 0.875;
			} else if (bounceAmount.getValue().equals(edu.cmu.cs.stage3.alice.core.Amount.TINY)) {
				recoilFrontUpperAngle = 0.0;
				recoilBackLowerAngle = 0.5;
			}

			if (stepAmount.getValue().equals(edu.cmu.cs.stage3.alice.core.Amount.HUGE)) {
				contactAngle = normalContactAngle * 1.5;
			} else if (stepAmount.getValue().equals(edu.cmu.cs.stage3.alice.core.Amount.BIG)) {
				contactAngle = normalContactAngle * 1.25;
			} else if (stepAmount.getValue().equals(edu.cmu.cs.stage3.alice.core.Amount.NORMAL)) {
				contactAngle = normalContactAngle;
			} else if (stepAmount.getValue().equals(edu.cmu.cs.stage3.alice.core.Amount.LITTLE)) {
				contactAngle = normalContactAngle * 0.75;
			} else if (stepAmount.getValue().equals(edu.cmu.cs.stage3.alice.core.Amount.TINY)) {
		...
		// in the step methods, portion is the portion for the current step, not
		// the animation
		// as a whole.
		...
		public void getCurrentOrientations() {
			...
			if (rightUpper != null) {
				rightUpperCurrentOrient = rightUpper.getOrientationAsAxes();
			}
			if (rightLower != null) {
				rightLowerCurrentOrient = rightLower.getOrientationAsAxes();
			}
			if (rightFoot != null) {
				rightFootCurrentOrient = rightFoot.getOrientationAsAxes();
			}

			if (leftUpper != null) {
				leftUpperCurrentOrient = leftUpper.getOrientationAsAxes();
			}
			if (leftLower != null) {
				leftLowerCurrentOrient = leftLower.getOrientationAsAxes();
			}
			if (leftFoot != null) {
				leftFootCurrentOrient = leftFoot.getOrientationAsAxes();
			}

			if (rightUpperArm != null) {
				rightUpperArmCurrentOrient = rightUpperArm.getOrientationAsAxes();
			}
			if (rightLowerArm != null) {
				rightLowerArmCurrentOrient = rightLowerArm.getOrientationAsAxes();
			}

			if (leftUpperArm != null) {
				leftUpperArmCurrentOrient = leftUpperArm.getOrientationAsAxes();
			}
			if (leftLowerArm != null) {
				leftLowerArmCurrentOrient = leftLowerArm.getOrientationAsAxes();
			}
		...
		public void setLegLengths() {
			...
			if (rightLower != null) {
				// this may want to be full distance (assuming that x,z offsets
				// are really small and unimportant)
			...
			if (rightUpper != null) {
				...
				if (rightLower != null) {
					bottom = rightLower.getPosition(rightUpper);
		...
		public void setInitialOrientations() {
			if (rightUpper != null) {
				rightUpperInitialOrient = rightUpper.getOrientationAsAxes(rightUpper);
			}
			// System.out.println("rightUpper: " + rightUpperInitialOrient);
			if (rightLower != null) {
				rightLowerInitialOrient = rightLower.getOrientationAsAxes(rightLower);
			}
			// System.out.println("rightLower: " + rightLowerInitialOrient);
			if (rightFoot != null) {
				rightFootInitialOrient = rightFoot.getOrientationAsAxes(rightFoot);
				// System.out.println("rightFoot: " + rightFootInitialOrient);
			}

			if (leftUpper != null) {
				leftUpperInitialOrient = leftUpper.getOrientationAsAxes(leftUpper);
			}
			// System.out.println("leftUpper: " + leftUpperInitialOrient);
			if (leftLower != null) {
				leftLowerInitialOrient = leftLower.getOrientationAsAxes(leftLower);
			}
			// System.out.println("leftLower: " + leftLowerInitialOrient);
			if (leftFoot != null) {
				leftFootInitialOrient = leftFoot.getOrientationAsAxes(leftFoot);
			...
			// System.out.println("rightUpperArm: " +
			// rightUpperArmInitialOrient);
			if (rightLowerArm != null) {
				rightLowerArmInitialOrient = rightLowerArm.getOrientationAsAxes(rightLowerArm);
				// System.out.println("rightLowerArm: " +
				// rightLowerArmInitialOrient);
			}
			...
			if (leftLowerArm != null) {
				leftLowerArmInitialOrient = leftLowerArm.getOrientationAsAxes(leftLowerArm);
				// System.out.println("leftLowerArm: " +
				// leftLowerArmInitialOrient);
			}
		...
		private void setQuaternion(edu.cmu.cs.stage3.alice.core.Transformable part, edu.cmu.cs.stage3.math.Matrix33 initialOrient, edu.cmu.cs.stage3.math.Matrix33 finalOrient, double portion) {
			...
			if (part != null) {
				...
				// part.name.getStringValue() + " " + currentOrient);
