...
//		search model to find the legs
		 public void findLegs() {
			 ...
			 for (int i = 0; i < legs.length; i++) {
				 if ((legs[i].getKey().indexOf("left") != -1) && (legs[i] instanceof edu.cmu.cs.stage3.alice.core.Transformable) ){
				 ...
				 } else if ((legs[i].getKey().indexOf("right") != -1) && (legs[i] instanceof edu.cmu.cs.stage3.alice.core.Transformable) ) {
