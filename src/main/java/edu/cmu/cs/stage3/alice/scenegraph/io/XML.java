...
public class XML {
			...
			if (propertyName.equals("Parent")) {
				...
				if (value != null) {
					...
					if (edu.cmu.cs.stage3.alice.scenegraph.Element.class.isAssignableFrom(propertyValueClass)) {
						...
						if (edu.cmu.cs.stage3.alice.scenegraph.Component.class.isAssignableFrom(propertyValueClass)) {} else {
	...
	private static void internalStore(edu.cmu.cs.stage3.alice.scenegraph.Component component, java.io.OutputStream os) throws java.lang.NoSuchMethodException, java.lang.reflect.InvocationTargetException, java.lang.IllegalAccessException, javax.xml.parsers.ParserConfigurationException, java.io.IOException, java.io.FileNotFoundException {
	...
	private static edu.cmu.cs.stage3.alice.scenegraph.Component decodeComponent(org.w3c.dom.Element xmlComponent, java.util.Dictionary map, java.util.Vector referencesToBeResolved) {
		...
		for (Element element : xmlChildren) {
			decodeComponent(element, map, referencesToBeResolved).setParent((edu.cmu.cs.stage3.alice.scenegraph.Container) sgComponent);
		}
		return sgComponent;
	}
	private static edu.cmu.cs.stage3.alice.scenegraph.Component internalLoad(java.io.InputStream is) throws org.xml.sax.SAXException, javax.xml.parsers.ParserConfigurationException, java.io.IOException {
		javax.xml.parsers.DocumentBuilderFactory factory = javax.xml.parsers.DocumentBuilderFactory.newInstance();
		javax.xml.parsers.DocumentBuilder builder = factory.newDocumentBuilder();
	...
	public static edu.cmu.cs.stage3.alice.scenegraph.Component load(java.io.InputStream is) {
		try {
			...
			java.util.zip.ZipEntry zipEntry = zis.getNextEntry(); // todo: check
																	// to ensure
																	// it is
																	// root.xml
