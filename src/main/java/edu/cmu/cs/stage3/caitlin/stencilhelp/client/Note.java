...
public class Note implements StencilObject, MouseEventListener, KeyEventListener, StencilObjectPositionListener, ReadWriteListener, LayoutChangeListener {
	...
	private Line2D.Double line = null, line2 = null, line3 = null,
			line4 = null, line5 = null;
	...
	protected void generateShapes() {
		...
		if (noteNumber.length() > 0) {
			tabRect = new RoundRectangle2D.Double(bgRect.getX() - tabRectOffset, bgRect.getY(), tabRectWidth, tabRectHeight, 15, 15);
		...
		TextLayout tl = new TextLayout(noteNumber, new java.awt.Font("Comic Sans MS", 1, fontSize), new FontRenderContext(null, false, false));
