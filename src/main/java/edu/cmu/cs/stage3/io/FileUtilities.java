...
public class FileUtilities {
	 ...
	 * edu.cmu.cs.stage3.progress.ProgressObserver progressObserver = new
	 * edu.cmu.cs.stage3.progress.ProgressObserver() { public void
	 * progressBegin( int total ) { System.err.println( "progressBegin: " +
	 * total ); } public void progressUpdateTotal( int total ) {
	 * System.err.println( "progressUpdateTotal: " + total ); } public void
	 * progressUpdate( int current, String description ) throws
	 * edu.cmu.cs.stage3.progress.ProgressCancelException { if( current >
	 * 1000000 ) { throw new
	 * edu.cmu.cs.stage3.progress.ProgressCancelException(); }
	 * System.err.println( "progressUpdate: " + current + " " + description ); }
	 * public void progressEnd() { System.err.println( "progressEnd" ); } }; try
	 ...
	 * i<sb.length(); i++ ) { if( Character.isLetterOrDigit( sb.charAt( i ) ) )
	 ...
	 * edu.cmu.cs.stage3.progress.ProgressPane( "Backing up: " + src.getPath(),
	 * dst.getPath() ) { protected void construct() throws
	 ...
	 * java.util.Calendar.JANUARY: sb.append( "Jan " ); break; case
	 * java.util.Calendar.FEBRUARY: sb.append( "Feb " ); break; case
	 * java.util.Calendar.MARCH: sb.append( "Mar " ); break; case
	 * java.util.Calendar.APRIL: sb.append( "Apr " ); break; case
	 * java.util.Calendar.MAY: sb.append( "May " ); break; case
	 * java.util.Calendar.JUNE: sb.append( "Jun " ); break; case
	 * java.util.Calendar.JULY: sb.append( "Jul " ); break; case
	 * java.util.Calendar.AUGUST: sb.append( "Aug " ); break; case
	 * java.util.Calendar.SEPTEMBER: sb.append( "Sep " ); break; case
	 * java.util.Calendar.OCTOBER: sb.append( "Oct " ); break; case
	 * java.util.Calendar.NOVEMBER: sb.append( "Noc " ); break; case
	 * java.util.Calendar.DECEMBER: sb.append( "Dec " ); break; } sb.append(
	 * calendar.get( java.util.Calendar.DAY_OF_MONTH ) ); sb.append( " " );
	 * sb.append( calendar.get( java.util.Calendar.YEAR ) ); sb.append( " at "
	 * ); sb.append( calendar.get( java.util.Calendar.HOUR ) ); sb.append( " "
	 * ); sb.append( calendar.get( java.util.Calendar.MINUTE ) ); sb.append( " "
	 * ); sb.append( calendar.get( java.util.Calendar.SECOND ) ); switch(
	 * calendar.get( java.util.Calendar.AM_PM ) ) { case java.util.Calendar.AM:
	 * sb.append( " AM" ); break; case java.util.Calendar.PM: sb.append( " PM"
