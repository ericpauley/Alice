...
public class Manager {
	...
	// edu.cmu.cs.stage3.media.DataSource dataSource =
	// edu.cmu.cs.stage3.media.Manager.createDataSource( file );
	// dataSource.addDataSourceListener( new
	// edu.cmu.cs.stage3.media.event.DataSourceListener() {
	// public void durationUpdated(
	// edu.cmu.cs.stage3.media.event.DataSourceEvent e ) {
	...
	// player.addPlayerListener( new
	// edu.cmu.cs.stage3.media.event.PlayerListener() {
