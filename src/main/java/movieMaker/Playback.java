...
/**
 * The class <code>Playback</code> extends from <code>Thread</code> and allows
...
public class Playback extends Thread {
	...
	/**
	 * Stops this thread by breaking the while loop in the run method. Used, for
	 * example, by the "stop" button in the SoundExplorer class.
	 */
	 ...
	 * SourceDataLine. If a SoundExplorer exists, upon creation of the
